...
export default function StandoutDishes() {
  return (
    <div className="wrapper flex flex-col w-full h-screen px-20 mt-24 pt-10 bg-green-500">
      <div className="description flex flex-col mb-7 h-fit">
        <h1 className="text-slate-100 text-lg font-medium mb-5 tracking-wide">
          SPECIAL DISHES
        </h1>
        <p className="text-5xl w-2/6 font-semibold text-red-600">
                ...
                >
                  <div className=" mr-2 flex justify-items-center items-center  p-2">
                    <Image
                      ...
                      priority
                    />
                  </div><div className="flex flex-col justify-start w-full">
                  <h5 className="font-bold text-lg">Fattoush salad</h5>
                  <p>Description of the item</p>
                  <div className="flex justify-between mt-1">
<h1 className="text-slate-500 font-medium text-base"><span className="text-red-400 font-bold text-base mr-1">$</span >24.00</h1>
<div className="flex text-slate-500 ">  <Image
                      src="/rating.png"
                      alt="Vercel Logo"
                      ...
                      height={30}
                      priority
                    /><span className="font-semibold">4.9</span></div>
                  </div>
                  </div>
              ...
              <div className="card_1 flex w-full justify-center  items-center">
                ...
                >
                  ...
                  <p>Description of the item</p>
                  <div className="flex justify-between mt-1">
<h1 className="text-slate-500 font-medium text-base"><span className="text-red-400 font-bold text-base mr-1">$</span >44.00</h1>
<div className="flex text-slate-500 ">  <Image
                      src="/rating.png"
                      alt="Vercel Logo"
                      className="dark:invert rounded-full mr-1"
              ...
              <div className="card_1 flex w-full justify-center  items-center">
                ...
                >
                  ...
                  <p>Description of the item</p>
                  <div className="flex justify-between mt-1">
<h1 className="text-slate-500 font-medium text-base"><span className="text-red-400 font-bold text-base mr-1">$</span >30.00</h1>
<div className="flex text-slate-500 ">  <Image
                      src="/rating.png"
                      alt="Vercel Logo"
                      className="dark:invert rounded-full mr-1"
