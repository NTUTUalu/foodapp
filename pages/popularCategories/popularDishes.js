...
export default function PopularDishes() {
  return (
    <>
      <div className="wrapper  flex flex-col w-full h-96 px-20 text-center max-md:px-10">
        ...
        <div className="right w-full  grid  grid-cols-4 gap-4 h-3/5 bg-blue-200 max-md:">
          <div className="card_1 flex justify-center  items-center bg-blue-500">
