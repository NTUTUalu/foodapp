...
export default function PopularDishes() {
  return (
    <>
      <div className="wrapper  flex flex-col w-full h-96 px-20 text-center">
        ...
        <div className="right w-full  grid  grid-cols-4 gap-4 h-3/5 p">
          <div className="card_1 flex justify-center  items-center">
        
          <div className={`${Styles.CardShadow} bg-slate-50 w-5/6 h-full rounded-xl flex flex-col p-6 justify-evenly items-center`}>
