...
<div className="wrapper flex w-full h-screen ">
    <div className="left flex flex-col  w-1/2 mt-24  ">
        <h1 className="text-5xl font-bold w-5/6 leading-tight">Dive into Delights <br/>Of Delectable <span className="text-green-500 ">Food</span></h1>
        <p className="text-slate-500 font-medium w-4/6 mt-8 mb-7 max-md:text-blue-500">Where Each Plate Weaves a Story of Culinary Mastery and Passionate Craftmanship</p>
